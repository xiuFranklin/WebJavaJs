              ...
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                      ...
                      <tr>
                        <td>FirstName</td>
                        <td><input type="text" value="{{userDetails.firstName}}"/></td>
                      </tr>
                       <tr>
                        <td>Middle Name</td>
                        <td><input type="text" value="{{userDetails.middleName}}"/></td>
                      </tr>
                      <tr>
                        <td>Marga:</td>
                        <td><input type="text" value="{{userDetails.marga}}"/> </td>
                      </tr>
                      <tr>
                        <td>Alamat</td>
                        <td><input type="text" value="{{userDetails.alamat}}"/></td>
                      </tr>
