...
<title>${tag.tagName} - 乱七八糟</title>
<meta name="description" content="coriger 夏末冬初  ${tag.tagName}" />
<meta name="keywords" content="coriger 夏末冬初  ${tag.tagName}"/>
<style type="text/css">
	img.wp-smiley,
	img.emoji {
...
<div class="content-wrap">
	<div class="content" id="content">
						<h3 class="title"><strong>标签：${tag.tagName}</strong></h3>
...
<script type="text/javascript" src="<%=basePath%>js/tag/article_list.js"></script>
