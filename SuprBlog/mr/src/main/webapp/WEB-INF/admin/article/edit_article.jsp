...
<body>
                            ...
                            <div class="ibox-content">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="title" class="form-control" placeholder="请输入标题" value="${article.title}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            <button class="btn btn-primary" type="button" onclick="editArticle()">保存内容</button>
                                            <button class="btn btn-white" type="button" onclick="cancleEditArticle()">取消</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="<%=basePath%>js/article/edit_article.js"></script>
