...
<body>
                    ...
                    <jsp:include page="../header.jsp" flush="true"></jsp:include>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                            	<a href="<%=basePath%>admin/article/list">文章列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                            	<a href="<%=basePath%>admin/tag/list">标签列表</a>
                            </li>
                        </ul>
                    </li>
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active">
                            	<a href="<%=basePath%>admin/friend/list">合作伙伴列表</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="<%=basePath%>admin/home">主页</a>
                        </li>
                        <li>
                            <a>合作伙伴管理</a>
                        </li>
                            ...
                            <div class="ibox-content">
								<div class="row">
									<form class="form-inline">
	                                    ...
	                                    <button type="button" class="btn btn-sm btn-danger" onclick="addPartner()">新增合作伙伴</button>
                                    </form>
                                </div>
    ...
    <!-- 编辑页面 -->
    <div class="modal inmodal" id="editPartnerModal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div id="editPartnerContent" class="modal-body">
    ...
    <!-- 新增页面 -->
    <div class="modal inmodal" id="addPartnerModal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div id="addPartnerContent" class="modal-body">
    ...
    <script src="<%=basePath%>js/partner/partner.js"></script>
