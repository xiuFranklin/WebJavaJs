...
<head>
	...
	<style>
		.wel-text{height:813px;background:#FFF url(<%=basePath%>img/home.jpg) center 100px no-repeat;}
	</style>
</head>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                            	<a href="<%=basePath%>admin/partner/list">合作伙伴列表</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message"><a href="javascript:void(0)"><i class="fa fa-home"></i></a>欢迎使用Mr管理后台</span>
                        </li>
                        <li>
                            <a href="<%=basePath%>out">
